...
namespace Cefform.DTO
{
    public class UserDTO
    {
        ...
        {
            return new UserDTO { FirstName = user.FirstName ?? "", LastName = user.LastName ?? "", Email = user.Email ?? "", Ceff = user.Ceff, Id = user.Iduser, Username = user.Username, Token = user.Token == "" ? null : user.Token };
        }
